 ...
 * </li>
 */
public class MainActivity extends Activity implements LocationClient.ConnectionCallbacks, LocationClient.OnConnectionFailedListener {
    ...
    // Google Map and Marker object for interactive mock locations
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the Location Client and connect it
                ...
                mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                    ...
                    public void onMapClick(LatLng latLng) {
                        ...
                        if (locationClient.isConnected()) {
                            mMarker = mMap.addMarker(new MarkerOptions().position(latLng).draggable(false));
                            Location mockLocation = createLocation(latLng.latitude, latLng.longitude, 3.0f);
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        Toast.makeText(this, "Failed to connect LocationClient", LENGTH_SHORT).show();
    }
